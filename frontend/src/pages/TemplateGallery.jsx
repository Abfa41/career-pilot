...
/>
      ...
      {/* One Page Scroll — sandboxed fixed-nav frame */}
      <div className="mt-12">
        <div className="mb-4 flex items-center gap-3 px-1">
          <span className="rounded-full bg-blue-500/15 px-3 py-1 text-xs font-bold uppercase tracking-widest text-blue-500 border border-blue-500/25">
            ● One Page Scroll
          </span>
          <h2 className="text-lg font-semibold text-foreground/70">One Page Scroll — Minimal Side-Dot Nav Full Template</h2>
        </div>
