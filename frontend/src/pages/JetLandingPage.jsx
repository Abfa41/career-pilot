        ...
        <div className="relative h-full flex flex-col z-10">
          ...
          <nav className="w-full max-w-7xl mx-auto px-8 py-6 flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="/login" className="text-gray-900 hover:text-gray-700 transition-colors font-medium">Login</a>
            </div>
          ...
          {isMobileMenuOpen && (
            <div className="absolute top-24 left-4 right-4 bg-white/95 backdrop-blur-md rounded-2xl shadow-xl z-20 md:hidden p-4 transition-all">
              <div className="flex flex-col space-y-4 text-center">
                {['Templates', 'Portfolio', 'Jobs', 'Resume', 'Login'].map((item) => (
                  <a 
                    key={item} 
                    href={`/${item.toLowerCase()}`}
                    className="text-gray-900 font-medium py-2 hover:bg-gray-100 rounded-lg transition-colors"
